<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewQuotesAgentManager.aspx.cs" Inherits="Wepages_Quote_ViewQuotesAgentManager" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2>Quotes</h2>
    <asp:Label ID="lblSearchInput" runat="server" ForeColor="Red"></asp:Label>
    ...
    <asp:SqlDataSource ID="sdsViewQuotes" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
        ...
        SelectCommand="ViewQuotesAgentManager" SelectCommandType="StoredProcedure" >
        <SelectParameters>
