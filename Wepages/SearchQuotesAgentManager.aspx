<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SearchQuotesAgentManager.aspx.cs" Inherits="Wepages_SearchQuotesAgentManager" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="sdsViewQuotes" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
        ...
        SelectCommand="SearchResultsAgentManager" SelectCommandType="StoredProcedure" >
        <SelectParameters>
